...
class NewVisitorTest(LiveServerTestCase):
    ...
    # def test_can_start_a_list_for_one_user(self):
    #     #Edith has heard a new coll online to-do app, she goses
    #     #the page update again, and now shows both items on her list
    #     self.wait_for_row_in_list_table('1:Buy peacock feathers')
    #     self.wait_for_row_in_list_table('2:Use peacock feathers to make a fly')
    #     #Satisfied she goes to sleep
    ...
    def test_multiple_users_can_start_at_different_urls(self):
        ...
        ##of Edith's is comeing through from cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
        ...
        #Francis start a new list by entering a new item, he is less interesting than Edith...
        inputbox = self.browser.find_element_by_id('id_new_item')
